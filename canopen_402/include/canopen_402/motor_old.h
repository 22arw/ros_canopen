...
//This is where the original DefaultHomingMode class was, it was moved on 03/24
...
public:
    ...
    : MotorBase(name), status_word_(0),control_word_(0),
      ...
      //this->this->bit_shift_(0x0000)	//Added for testing on 03/24
    {
	...
	//This was moved into class on 03/24 to make new duplicate class
...
private:
	...
	//uint16_t this->bit_shift_;	//added for modificaiton on 03/24
